  ...
  return (
    <Card className="shadow-md border-primary/20">
      <CardHeader className="pb-2">
        ...
        <CardDescription>
          AI-powered feedback on your cover letter
        </CardDescription>
      </CardHeader>
      <CardContent className="pt-4">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-sm text-muted-foreground text-center max-w-md">
            {score.overall >= 80
              ? "Excellent! Your cover letter is well-written and ready to impress employers."
              : score.overall >= 60
              ? "Good start! With a few improvements, your cover letter will stand out more."
              : "Needs work. Follow our suggestions to significantly improve your cover letter."}
          </p>
        </div>
      ...
      <CardFooter className="border-t p-4 bg-muted/20">
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span>
            Apply the AI suggestions to improve your score and make your cover
